  ...
  return (
    <nav className='flex justify-between lg:mx-20 items-center h-[86.41px] p-2'>
        <ul className='flex items-center gap-8 font-semibold text-base '>
            ...
            <li className='hover:shadow-2xl hover:shadow-black/60 rounded-full px-5 py-3 transition-all duration' >
              <Link href={`/photo`}>
                Photo
              </Link>
            </li>
            ...
            <li className='flex items-center hover:shadow-2xl hover:shadow-black/60 rounded-full px-5 py-3 transition-all duration'>
              <Link href={`/ai-generator`} className='flex items-center'>
                <BsStars fontSize={10} className=''/>
                Ai Generator
              </Link>
            </li>
            <li className='hover:shadow-2xl hover:shadow-black/60 rounded-full px-5 py-3 transition-all duration'>Become a Contributor</li>
        </ul>
