...
import image1 from '../../../public/assets/Photo interacrtions.png'
...
const PopularTrends = () => {
  return (
    <Wrapper>
        <div>
            <p className='font-bold text-[28px] py-10'>Explore the most popular and trending nature background</p>
            <div className='flex justify-center w-full gap-4'>
                <div className='w-[400px] space-y-4'>
                    <Image src={image1} alt='image' className='h-[409px] w-full'/>
                    <Image src={image1} alt='image' className='h-[409px] w-full'/>
                    <Image src={image1} alt='image' className='h-[409px] w-full'/>
                </div>
                <div className='w-[400px] space-y-4'>
